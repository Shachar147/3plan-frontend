...
const utilityPatterns = [
	...
	{
		regex: /padding-top:\s*(\d+)px(\s*|;|})/,
		className: 'padding-top-$1',
		cssRule: '.padding-top-$1 { padding-top: $1px; }',
	},
	{
		regex: /padding-bottom:\s*(\d+)px(\s*|;|})/,
		className: 'padding-bottom-$1',
		cssRule: '.padding-bottom-$1 { padding-bottom: $1px; }',
	},
	{
		regex: /padding-left:\s*(\d+)px(\s*|;|})/,
		className: 'padding-left-$1',
		cssRule: '.padding-left-$1 { padding-left: $1px; }',
	},
	{
		regex: /padding-right:\s*(\d+)px(\s*|;|})/,
		className: 'padding-right-$1',
		cssRule: '.padding-right-$1 { padding-right: $1px; }',
	},
	...
	{
		regex: /margin-top:\s*(\d+)px(\s*|;|})/,
		className: 'margin-top-$1',
		cssRule: '.margin-top-$1 { margin-top: $1px; }',
	},
	{
		regex: /margin-bottom:\s*(\d+)px(\s*|;|})/,
		className: 'margin-bottom-$1',
		cssRule: '.margin-bottom-$1 { margin-bottom: $1px; }',
	},
	{
		regex: /margin-left:\s*(\d+)px(\s*|;|})/,
		className: 'margin-left-$1',
		cssRule: '.margin-left-$1 { margin-left: $1px; }',
	},
	{
		regex: /margin-right:\s*(\d+)px(\s*|;|})/,
		className: 'margin-right-$1',
		cssRule: '.margin-right-$1 { margin-right: $1px; }',
	},
	...
	{
		regex: /min-width:\s*(\d+)px(\s*|;|})/,
		className: 'min-width-$1',
		cssRule: '.min-width-$1 { min-width: $1px; }',
	},
	{
		regex: /max-width:\s*(\d+)px(\s*|;|})/,
		className: 'max-width-$1',
		cssRule: '.max-width-$1 { max-width: $1px; }',
	},

	// Height
	{
		regex: /height:\s*100%(\s*|;|})/,
		className: 'height-100-percent',
		cssRule: '.height-100-percent { height: 100%; }',
	},
	{ regex: /height:\s*(\d+)px(\s*|;|})/, className: 'height-$1', cssRule: '.height-$1 { height: $1px; }' },
	{
		regex: /min-height:\s*(\d+)px(\s*|;|})/,
		className: 'min-height-$1',
		cssRule: '.min-height-$1 { min-height: $1px; }',
	},
	{
		regex: /max-height:\s*(\d+)px(\s*|;|})/,
		className: 'max-height-$1',
		cssRule: '.max-height-$1 { max-height: $1px; }',
	},

	// Flex
	{ regex: /display:\s*flex(\s*|;|})/, className: 'display-flex', cssRule: '.display-flex { display: flex; }' },
	{
		regex: /flex-direction:\s*row(\s*|;|})/,
		className: 'flex-row',
		cssRule: '.flex-row { display: flex; flex-direction: row; }',
	},
	{
		regex: /flex-direction:\s*column(\s*|;|})/,
		className: 'flex-column',
		cssRule: '.flex-column { display: flex; flex-direction: column; }',
	},
	...
	{
		regex: /justify-content:\s*center(\s*|;|})/,
		className: 'justify-center',
		cssRule: '.justify-center { justify-content: center; }',
	},
	{
		regex: /justify-content:\s*flex-start(\s*|;|})/,
		className: 'justify-start',
		cssRule: '.justify-start { justify-content: flex-start; }',
	},
	{
		regex: /justify-content:\s*flex-end(\s*|;|})/,
		className: 'justify-end',
		cssRule: '.justify-end { justify-content: flex-end; }',
	},
	{
		regex: /justify-content:\s*space-between(\s*|;|})/,
		className: 'justify-between',
		cssRule: '.justify-between { justify-content: space-between; }',
	},
	{
		regex: /align-items:\s*center(\s*|;|})/,
		className: 'align-center',
		cssRule: '.align-center { align-items: center; }',
	},
	{
		regex: /align-items:\s*flex-start(\s*|;|})/,
		className: 'align-start',
		cssRule: '.align-start { align-items: flex-start; }',
	},
	{
		regex: /align-items:\s*flex-end(\s*|;|})/,
		className: 'align-end',
		cssRule: '.align-end { align-items: flex-end; }',
	},
	{ regex: /gap:\s*(\d+)px(\s*|;|})/, className: 'gap-$1', cssRule: '.gap-$1 { gap: $1px; }' },

	// Position
	{
		regex: /position:\s*relative(\s*|;|})/,
		className: 'position-relative',
		cssRule: '.position-relative { position: relative; }',
	},
	{
		regex: /position:\s*absolute(\s*|;|})/,
		className: 'position-absolute',
		cssRule: '.position-absolute { position: absolute; }',
	},
	{
		regex: /position:\s*fixed(\s*|;|})/,
		className: 'position-fixed',
		cssRule: '.position-fixed { position: fixed; }',
	},

	// Text alignment
	{
		regex: /text-align:\s*center(\s*|;|})/,
		className: 'text-center',
		cssRule: '.text-center { text-align: center; }',
	},
	...
	{
		regex: /border-radius:\s*(\d+)px(\s*|;|})/,
		className: 'border-radius-$1',
		cssRule: '.border-radius-$1 { border-radius: $1px; }',
	},

	// Fonts
	{ regex: /font-weight:\s*bold(\s*|;|})/, className: 'font-bold', cssRule: '.font-bold { font-weight: bold; }' },
	{
		regex: /font-size:\s*(\d+)px(\s*|;|})/,
		className: 'font-size-$1',
		cssRule: '.font-size-$1 { font-size: $1px; }',
	},
];
...
const additionalPatterns = [
	// Overflow
	{
		regex: /overflow:\s*hidden(\s*|;|})/,
		className: 'overflow-hidden',
		cssRule: '.overflow-hidden { overflow: hidden; }',
	},
	{ regex: /overflow:\s*auto(\s*|;|})/, className: 'overflow-auto', cssRule: '.overflow-auto { overflow: auto; }' },
	{
		regex: /overflow:\s*scroll(\s*|;|})/,
		className: 'overflow-scroll',
		cssRule: '.overflow-scroll { overflow: scroll; }',
	},
	{
		regex: /overflow-x:\s*hidden(\s*|;|})/,
		className: 'overflow-x-hidden',
		cssRule: '.overflow-x-hidden { overflow-x: hidden; }',
	},
	{
		regex: /overflow-y:\s*hidden(\s*|;|})/,
		className: 'overflow-y-hidden',
		cssRule: '.overflow-y-hidden { overflow-y: hidden; }',
	},
	{
		regex: /overflow-x:\s*auto(\s*|;|})/,
		className: 'overflow-x-auto',
		cssRule: '.overflow-x-auto { overflow-x: auto; }',
	},
	{
		regex: /overflow-y:\s*auto(\s*|;|})/,
		className: 'overflow-y-auto',
		cssRule: '.overflow-y-auto { overflow-y: auto; }',
	},
	{
		regex: /overflow-x:\s*scroll(\s*|;|})/,
		className: 'overflow-x-scroll',
		cssRule: '.overflow-x-scroll { overflow-x: scroll; }',
	},
	{
		regex: /overflow-y:\s*scroll(\s*|;|})/,
		className: 'overflow-y-scroll',
		cssRule: '.overflow-y-scroll { overflow-y: scroll; }',
	},

	// Display
	{ regex: /display:\s*block(\s*|;|})/, className: 'display-block', cssRule: '.display-block { display: block; }' },
	{
		regex: /display:\s*inline-block(\s*|;|})/,
		className: 'display-inline-block',
		cssRule: '.display-inline-block { display: inline-block; }',
	},
	{ regex: /display:\s*none(\s*|;|})/, className: 'display-none', cssRule: '.display-none { display: none; }' },

	// Cursor
	{
		regex: /cursor:\s*pointer(\s*|;|})/,
		className: 'cursor-pointer',
		cssRule: '.cursor-pointer { cursor: pointer; }',
	},
	{
		regex: /cursor:\s*not-allowed(\s*|;|})/,
		className: 'cursor-not-allowed',
		cssRule: '.cursor-not-allowed { cursor: not-allowed; }',
	},

	// Background
	{
		regex: /background:\s*transparent(\s*|;|})/,
		className: 'bg-transparent',
		cssRule: '.bg-transparent { background: transparent; }',
	},
	{
		regex: /background-color:\s*transparent(\s*|;|})/,
		className: 'bg-transparent',
		cssRule: '.bg-transparent { background-color: transparent; }',
	},
	...
	// White space
	{
		regex: /white-space:\s*nowrap(\s*|;|})/,
		className: 'whitespace-nowrap',
		cssRule: '.whitespace-nowrap { white-space: nowrap; }',
	},
	{
		regex: /white-space:\s*pre(\s*|;|})/,
		className: 'whitespace-pre',
		cssRule: '.whitespace-pre { white-space: pre; }',
	},
	{
		regex: /white-space:\s*pre-line(\s*|;|})/,
		className: 'whitespace-pre-line',
		cssRule: '.whitespace-pre-line { white-space: pre-line; }',
	},
	{
		regex: /white-space:\s*pre-wrap(\s*|;|})/,
		className: 'whitespace-pre-wrap',
		cssRule: '.whitespace-pre-wrap { white-space: pre-wrap; }',
	},

	// Line height
	{
		regex: /line-height:\s*(\d+)px(\s*|;|})/,
		className: 'line-height-$1',
		cssRule: '.line-height-$1 { line-height: $1px; }',
	},

	// Text decoration
	{
		regex: /text-decoration:\s*none(\s*|;|})/,
		className: 'text-decoration-none',
		cssRule: '.text-decoration-none { text-decoration: none; }',
	},
	{
		regex: /text-decoration:\s*underline(\s*|;|})/,
		className: 'text-underline',
		cssRule: '.text-underline { text-decoration: underline; }',
	},
];
