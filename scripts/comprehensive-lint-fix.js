  ...
  try {
    ...
    if (eqeqIssues.length > 0) {
      ...
      eqeqIssues.forEach(issue => {
        ...
        const newLine = line.substring(0, issue.column - 1) + 
        ...
        if (issue.suggestions && issue.suggestions.length > 0) {
          ...
          if (startPos && endPos) {
            ...
            if (startPos.line === endPos.line) {
              ...
              lines[startPos.line] = line.substring(0, startPos.column) + fixText + line.substring(endPos.column);
            } else {
              // Multi-line fix
      ...
      unusedVarsIssues.forEach(msg => {
        ...
        if (unusedVar) {
          ...
          importLines.forEach(importLine => {
            ...
            if (importLine.includes(` ${unusedVar}`) || 
              ...
              if ((importLine.includes(`{ ${unusedVar} }`) || importLine.includes(`{${unusedVar}}`) || 
