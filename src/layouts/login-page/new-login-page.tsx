...
import './new-login-page.scss';
import TextInput, { TextInputRef } from '../../components/inputs/text-input/text-input';
...
function LoginPage() {
	...
	function renderField({ name, placeholder, icon, type = 'text', ref }: any) {
		return (
			<div className="field">
				<i className={getClasses(icon, 'icon')} />
				<input
					name={name}
					className="textInput"
					type={type}
	...
	return (
		<div className="login-page">
			<div className="login-page-form">
				<form className="login-page-main-content">
					{message_block}
					{error_block}
					<TextInput
						name="username"
			...
			<div className="login-page-image">b</div>
		</div>
	);
