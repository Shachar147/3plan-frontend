...
function LoginPageV2() {
	...
	useEffect(() => {
		...
		if (
			localStorageVal &&
			['login', 'register'].includes(localStorageVal) &&
			window.location.hash.includes(localStorageVal)
		) {
		...
		return (
			<div className="field flex-column gap-4">
				...
				<input
					...
					placeholder={
						eventStore.isMobile ||
						(eventStore.isEnglish &&
							placeholder == TranslateService.translate(eventStore, 'REPEAT_PASSWORD'))
							? placeholder
							: TranslateService.translate(eventStore, 'TYPE_YOUR_X', {
									X: placeholder,
							  })
					}
					autoComplete="off"
				...
				<div className="login-page-container">
					...
					<div className="flex-column gap-8">
						<div className="flex-column block-title">
							...
							<span className="white-space-pre-line max-width-350">
								{TranslateService.translate(eventStore, 'LOGIN_PAGE_V2.LOGIN.DESCRIPTION')}
							</span>
						</div>
						{renderLoginForm()}
					</div>
				...
				<div className="register-page-container">
					...
					<div className="flex-column gap-8">
						<div className="flex-column block-title">
							...
							<span className="white-space-pre-line max-width-350">
								{TranslateService.translate(eventStore, 'LOGIN_PAGE_V2.REGISTER.DESCRIPTION')}
							</span>
						</div>
						{renderRegisterForm()}
					</div>
