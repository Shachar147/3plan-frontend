...
function TripTemplateDay({ events, baseClass, idx, counter }: { events: CalendarEvent[], baseClass: string, idx: number, counter: number }) {
    ...
    return (
        <div className={`${baseClass}-day-container`}>
            ...
            {events.filter((e) => e.title).map((e, idx2) => {
