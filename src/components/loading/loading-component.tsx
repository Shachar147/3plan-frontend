...
function LoadingComponent({title, message, loaderDetails }: LoadingComponentProps){
    ...
    return (
        <div style={{
            ...
            <div className="flex-column align-items-center justify-content-center" style={{ width: "100%", height: "100%", backgroundColor: loaderDetails.backgroundColor }} >
                <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center" }}>
                    <div>
                        <img src={loaderDetails.loader} style={{ width: "80%", maxWidth: "800px" }} />
                        <div className="flex-col gap-15 padding-top-50 align-items-center justify-content-center" style={{ top: loaderDetails.top }}>
                            <div style={{ fontSize: "20px", color: loaderDetails.titleTextColor }}><b>{title}</b></div>
