...
import {
    ...
    getClasses,
    getCurrentUsername, isBasketball, isDessert, isFlight, isFlightCategory, isHotel,
    isHotelsCategory, locationToString, toDistanceString,
    ucfirst
} from "../../utils/utils";
...
import {
    addHours,
    formatDate,
    formatFromISODateString, formatTimeFromISODateString, getDurationString,
    getOffsetInHours,
...
import {SidebarGroups, TriplanSidebarProps, wrapWithSidebarGroup} from "./triplan-sidebar";
...
const TriplanSidebarInner = (props: TriplanSidebarProps) => {
    ...
    return (
        <div>
            <div className="triplan-sidebar-inner-header flex-row gap-10 sticky-0">
