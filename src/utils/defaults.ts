...
export const defaultEventsOld: Record<number, SidebarEvent[]> = {
    1: [
        ...
        { id: "801", title: "Blaze Pizza (mall)", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.nevermind },
        { id: "802", title: "Serial Cafe Killer (mall)", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.nevermind },
        { id: "803", title: "candylicious candy store (mall)", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.nevermind },
        { id: "804", title: "Ben Kukis (mall)", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.nevermind },

        { id: "805", title: "Forever Rose Cafe", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.morning },
        { id: "806", title: "Saya Restaurant", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.morning },
        { id: "807", title: "Brunch and Cake - bubble cafe", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.morning },
        { id: "808", title: "Black Tap - decadent desserts", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.morning },
        { id: "809", title: "Lighthouse?\n(And then The Block? They're close)", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.morning },
        { id: "810", title: "Nutella (at the airport)", priority: TriplanPriority.least, preferredTime: TriplanEventPreferredTime.morning },
        { id: "811", title: "Atmosphere Restaurant", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.morning },
        { id: "812", title: "Vibe restaurant", priority: TriplanPriority.least, preferredTime: TriplanEventPreferredTime.morning },

        { id: "813", title: "Nussert Steakhouse", description: "המסעדה של נאסר", duration: '02:00', priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.noon },
        { id: "814", title: "Pizza Company", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.noon },
        { id: "815", title: "The Pods restaurant", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.noon },
        { id: "816", title: "Nonya restaurant?", priority: TriplanPriority.least, preferredTime: TriplanEventPreferredTime.noon },
        { id: "817", title: "zou zou restaurant (mall)?", priority: TriplanPriority.least, preferredTime: TriplanEventPreferredTime.noon },
        { id: "818", title: "Trove Restaurant", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.noon },
        { id: "819", title: "Hard Rock Cafe", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.noon },
        { id: "820", title: "Vapiano", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.noon },
        { id: "821", title: "Armani Dubai restaurant? (+ view the Fountains?)", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.noon },

        { id: "822", title: "Gordon Ramzi Hell Kitchen", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.evening },
        { id: "823", title: "Ce La Vie", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.evening },
        { id: "824", title: "Gal Dubai", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.evening },
        { id: "825", title: "Gaya Restaurant + Nyx Secret Bar", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.evening },
        { id: "826", title: "Coya Restaurant + Coya Members Secret Bar", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.evening },
        { id: "827", title: "Tasca restaurant?", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.sunset },
        { id: "828", title: "Varda restaurant?", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.evening },
        { id: "829", title: "Dubai Marina Cruise?", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.evening },
        { id: "830", title: "Knox Secret Pub", priority: TriplanPriority.must, preferredTime: TriplanEventPreferredTime.evening },
        { id: "831", title: "The unlucky Cat", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.evening },
        { id: "832", title: "Osasino - an underwater restaurant?", priority: TriplanPriority.least, preferredTime: TriplanEventPreferredTime.evening },
        { id: "833", title: "Dinner in the sky", priority: TriplanPriority.maybe, preferredTime: TriplanEventPreferredTime.evening },
    ],
    2: [
